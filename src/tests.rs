...
fn test_jungle_board_game() {
    ...
    assert_match("jungle-board-game-2020", "Jungle Board Game The Final Round (2020) [720p] [BluRay] [YTS.MX]/Jungle.Board.Game.The.Final.Round.2020.720p.BluRay.x264.AAC-[YTS.MX].mp4");
...
fn test_abandoned_child() {
    ...
    assert_match("abandoned child 2", "Abandoned Child 2 Forgotten in Manhattan (1993) [1080p]/Abandoned.Child.2.Forgotten.in.Manhattan.1993.1080p.BluRay.x264.YIFY.mp4");
}
...
fn test_bobby_wizard() {
    assert_match("bobby-wizard-escaped", "Bobby Wizard and the Escaped Criminal (2005) 1080p.BRrip.scOrp.sujaidr (pimprg)/Bobby Wizard and the Escaped Criminal (2005) 1080p.BRrip.scOrp.sujaidr (pimprg).mkv");
    assert_match("bobby-wizard-spooky-1", "Bobby Wizard and the Spooky Artifacts Part 1 (2011) [1080p]/Bobby.Wizard.and.the.Spooky.Artifacts.Part.1.2011.1080p.BrRip.x264.YIFY.mp4");
    assert_match("bobby-wizard-spooky-2", "Bobby Wizard and the Spooky Artifacts Part 2 (2012) 1080p.BRrip.scOrp.sujaidr (pimprg)/Bobby Wizard and the Spooky Artifacts Part 2 (2012) 1080p.BRrip.scOrp.sujaidr (pimprg).mkv");
}
...
fn test_artifact_hunter() {
    assert_match("artifact-hunter-final", "Artifact Hunter and the Final Quest (1990) [1080p]/Artifact.Hunter.And.The.Final.Quest.1990.1080p.BluRay.x264.YIFY.mp4");
    ...
    assert_match("artifact-hunter-wheel", "Artifact Hunter And The Wheel Of Fate (2024) [1080p] [WEBRip] [5.1] [YTS.MX]/Artifact.Hunter.And.The.Wheel.Of.Fate.2024.1080p.WEBRip.x264.AAC5.1-[YTS.MX].mp4");
}